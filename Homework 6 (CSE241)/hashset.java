...
public class hashset<E> implements set<E>{
	...
	public boolean add(E e){			// first controls for duplicates then, if capacity is full -> extends and adds the element 
	...
	public boolean isDuplicate(E e){	// controls duplicates and returns if it is
	...
	public  boolean addAll(collection c){		// tries 'add(E e)' for all of 'c's objects
		...
		for(i = 0;i < c.size();++i){
			try{
				...
				System.out.printf(" <- End of object array.\n");
			}	
		}
		return true;
	}
